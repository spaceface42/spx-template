...
export class FloatingImageManager {
    ...
    //    this._hoverPauseHandler = () => { this.isPausedByHover = true; };
    //    this._hoverResumeHandler = () => { this.isPausedByHover = false; };
    }
    ...
    addExistingImage(imgElement) {
        ...
        // Pause on hover
        imgElement.addEventListener('mouseenter', this._hoverPauseHandler);
        imgElement.addEventListener('mouseleave', this._hoverResumeHandler);
    }
    ...
    /**
     * Cleans up all observers, event listeners, and stops the animation loop.
     */
    destroy() {
    ...
    //    this.images.forEach(image => {
    //        image.element.removeEventListener('mouseenter', this._hoverPauseHandler);
    //        image.element.removeEventListener('mouseleave', this._hoverResumeHandler);
    //    });
    ...
    // Reset all floating images to new random positions
